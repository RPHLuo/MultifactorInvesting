...
for ticker in tickers:
    ...
    seq_technical_lstm.train(ticker=ticker, time_step=200, start=0, epochs=10, path=path)
    seq_fundamental_cnn.train(ticker=ticker, time_step=200, start=0, epochs=10, path=path)
    seq_technical_cnn.train(ticker=ticker, time_step=200, start=0, epochs=10, path=path)
